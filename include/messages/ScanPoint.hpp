...
#ifndef __messages_ScanPoint_hpp__
#define __messages_ScanPoint_hpp__
...
int ScanPoint::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ScanPoint::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ScanPoint::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t ScanPoint::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* ScanPoint::getTypeName()
{
    return "ScanPoint";
}

int ScanPoint::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ScanPoint::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ScanPoint::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
